...
Current release: **10.0.7**, fixing concurrent bridge-heartbeat writes while preserving the persistent mobile navigation and all existing measurement behavior.
