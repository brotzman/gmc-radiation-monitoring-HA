...
Current release: **10.0.20**, with narrower desktop header controls so the German subtitle remains on one line while the existing mobile reflow and floating section selector remain unchanged.
