...
Current release: **10.0.4**, a runtime hotfix that restores automatic device capability storage after the 10.0.3 history-model split and adds regression coverage for extracted-module imports.
