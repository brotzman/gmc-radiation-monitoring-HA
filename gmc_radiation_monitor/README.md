...
## Version 10.0.14: shorter German application title

Version 10.0.14 shortens the German dashboard and browser title from **GMC-Strahlungsüberwachung** to **Strahlungsüberwachung**. The subtitle **Lokale Überwachung für GQ-GMC-Geigerzähler** remains unchanged.

The change reduces visual width in desktop and mobile headers without altering the English source title, other interface languages, measurements, MQTT identities, database schema 8, detector profiles, thresholds, scientific calculations or serial protocols.
