...
Version 10.0.16 is a maintenance and archive-cleanup release. It removes obsolete dashboard styles, JavaScript handlers, rendering variables and empty wrappers that remained after the large status panel and segmented view selector were replaced by compact header controls.
