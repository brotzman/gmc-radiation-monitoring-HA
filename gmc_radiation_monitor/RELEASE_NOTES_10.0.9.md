# GMC Radiation Monitor 10.0.9

Version 10.0.9 introduces compact application-header controls. The previous row of language links is replaced by an accessible dropdown that preserves the current dashboard mode and selected GMC device. A localized refresh button beside it reloads the complete dashboard on demand.
