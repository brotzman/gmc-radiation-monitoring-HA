...
Version 8.2.1 is a localization and quality-assurance patch release for **Radiation Monitoring**. It retains the professional reporting and History-management features introduced in 8.2.0.

## Complete runtime localization

Two statistical explanations in the Intelligent radiation analysis card could still fall back to English because they were generated through dynamic `{"key": ...}` message dictionaries. Version 8.2.1 adds native translations for those messages in German, English, French, Spanish, Italian, Dutch, Polish and Croatian.

The translation audit now scans these dynamic analysis-message keys in addition to ordinary `t(...)`, metric and presentation keys. Cross-language rendering tests verify that non-English cards no longer expose the English significance or historical-rarity sentences.
