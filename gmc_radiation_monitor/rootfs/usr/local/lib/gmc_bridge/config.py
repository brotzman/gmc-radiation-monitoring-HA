...
class Settings:
    ...
    external_temperature_name: str = ""
    external_temperature_max_age_seconds: int = 900
    cosmic_hint_enabled: bool = False
    ...
    def from_env(cls) -> Settings:
        ...
        settings = cls(
            ...
            external_temperature_name=os.environ.get("EXTERNAL_TEMPERATURE_NAME", "").strip(),
            external_temperature_max_age_seconds=int(os.environ.get("EXTERNAL_TEMPERATURE_MAX_AGE_SECONDS", "900")),
            cosmic_hint_enabled=parse_bool("COSMIC_HINT_ENABLED", os.environ.get("COSMIC_HINT_ENABLED", "false")),
            pressure_weather_entity_primary=os.environ.get("PRESSURE_WEATHER_ENTITY_PRIMARY", "").strip(),
            pressure_weather_entity_secondary=os.environ.get("PRESSURE_WEATHER_ENTITY_SECONDARY", "").strip(),
