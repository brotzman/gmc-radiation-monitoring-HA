...
CATALOG.update({'{available} of {required} required hourly pairs are available.': '{available} of {required} required hourly pairs are available.', 'FDR-adjusted p={value}': 'FDR-adjusted p={value}', 'Practical magnitude not available': 'Practical magnitude not available', 'Moderate practical magnitude': 'Moderate practical magnitude', 'Estimated change {value}% per month · {magnitude}': 'Estimated change {value}% per month · {magnitude}', 'Runtime since service start': 'Runtime since service start', 'Cumulative counters reset when the service restarts.': 'Cumulative counters reset when the service restarts.', 'GMCMap transmission': 'GMCMap transmission', 'Export field-test protocol (JSON)': 'Veldtestprotocol exporteren (JSON)', '{months} represented calendar months': '{months} represented calendar months', 'Statistical process diagnostics': 'Statistische procesdiagnostiek', 'At least 30 sufficiently complete days and an adequate effective sample size are required.': 'At least 30 sufficiently complete days and an adequate effective sample size are required.', '{success} successful · {errors} failed uploads': '{success} successful · {errors} failed uploads', 'No statistically clear long-term trend is visible': 'No statistically clear long-term trend is visible', 'Longest data gap': 'Longest data gap', 'Stored samples: {count}': 'Stored samples: {count}', 'Field-test interpretation': 'Field-test interpretation', 'A falling long-term tendency is visible': 'A falling long-term tendency is visible', 'Large practical magnitude': 'Large practical magnitude', '{days} covered days · {observed} daily observations': '{days} covered days · {observed} daily observations', 'Data basis': 'Gegevensbasis', 'A rising long-term tendency is visible': 'A rising long-term tendency is visible', 'Small practical magnitude': 'Small practical magnitude', 'Current background context': 'Huidige achtergrondcontext', 'Annual projection from the last 90 days: {value} µSv': 'Jaarprojectie op basis van de laatste 90 dagen: {value} µSv', 'The main result first; method details remain available below.': 'The main result first; method details remain available below.', 'Annual projection is not shown until a sufficiently complete 90-day period exists.': 'De jaarprojectie verschijnt pas bij een voldoende volledige periode van 90 dagen.', 'Supported': 'Onderbouwd', 'Well supported': 'Goed onderbouwd', 'Extended statistical methods': 'Uitgebreide statistische methoden', 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.': 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.', 'USB / serial recovery': 'USB / serial recovery', 'Database write errors': 'Database write errors', 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.': 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.', 'Plain-language assessment': 'Begrijpelijke samenvatting', '{errors} serial errors · {reconnects} reconnects': '{errors} serial errors · {reconnects} reconnects', 'Long-term reliability field test': 'Veldtest voor langetermijnbetrouwbaarheid', 'No reliable long-term trend can be assessed yet': 'No reliable long-term trend can be assessed yet', 'Operational counters for USB, database continuity and GMCMap transmission': 'Operational counters for USB, database continuity and GMCMap transmission', 'EWMA, CUSUM and dispersion diagnostics; statistical context only': 'EWMA, CUSUM and dispersion diagnostics; statistical context only', '{count} detected gaps above the expected interval': '{count} detected gaps above the expected interval', 'Trend method details': 'Trend method details', 'FDR-adjusted significance not available': 'FDR-adjusted significance not available', 'Exploratory Spearman correlations with false-discovery-rate correction': 'Exploratory Spearman correlations with false-discovery-rate correction', 'Seasonal assessment': 'Seasonal assessment', 'Not evaluable': 'Niet beoordeelbaar', 'Integrated derived dose in the measured period': 'Integrated derived dose in the measured period', 'Exploratory': 'Verkennend', 'Confidence intervals, effective sample size, test statistics and practical effect size': 'Confidence intervals, effective sample size, test statistics and practical effect size', 'Very small practical magnitude': 'Very small practical magnitude'})

# Complete localized overrides for 9.3.0
CATALOG.update({'Not evaluable': 'Niet beoordeelbaar', 'Exploratory': 'Verkennend', 'Supported': 'Onderbouwd', 'Well supported': 'Goed onderbouwd', 'Very small practical magnitude': 'Zeer kleine praktische omvang', 'Small practical magnitude': 'Kleine praktische omvang', 'Moderate practical magnitude': 'Matige praktische omvang', 'Large practical magnitude': 'Grote praktische omvang', 'Practical magnitude not available': 'Praktische omvang niet beschikbaar', 'No reliable long-term trend can be assessed yet': 'Er kan nog geen betrouwbare langetermijntrend worden beoordeeld', 'At least 30 sufficiently complete days and an adequate effective sample size are required.': 'Minstens 30 voldoende volledige dagen en een passende effectieve steekproefgrootte zijn vereist.', 'A rising long-term tendency is visible': 'Een stijgende langetermijntendens is zichtbaar', 'A falling long-term tendency is visible': 'Een dalende langetermijntendens is zichtbaar', 'No statistically clear long-term trend is visible': 'Er is geen statistisch duidelijke langetermijntrend zichtbaar', 'Estimated change {value}% per month · {magnitude}': 'Geschatte verandering {value}% per maand · {magnitude}', 'Runtime since service start': 'Looptijd sinds het starten van de service', 'Cumulative counters reset when the service restarts.': 'Cumulatieve tellers worden bij een herstart van de service teruggezet.', 'USB / serial recovery': 'USB-/serieel herstel', '{errors} serial errors · {reconnects} reconnects': '{errors} seriële fouten · {reconnects} herverbindingen', 'Longest data gap': 'Langste gegevensonderbreking', '{count} detected gaps above the expected interval': '{count} gedetecteerde onderbrekingen boven het verwachte interval', 'Database write errors': 'Database-schrijffouten', 'Stored samples: {count}': 'Opgeslagen metingen: {count}', 'GMCMap transmission': 'GMCMap-overdracht', '{success} successful · {errors} failed uploads': '{success} geslaagd · {errors} mislukt', 'Export field-test protocol (JSON)': 'Veldtestprotocol exporteren (JSON)', 'Field-test interpretation': 'Interpretatie van de veldtest', 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.': 'Deze bedrijfstellers helpen de langetermijnbetrouwbaarheid te beoordelen. Ze certificeren de kalibratie of meetnauwkeurigheid niet.', '{available} of {required} required hourly pairs are available.': '{available} van {required} vereiste uurparen zijn beschikbaar.', 'FDR-adjusted p={value}': 'FDR-gecorrigeerde p={value}', 'FDR-adjusted significance not available': 'FDR-gecorrigeerde significantie niet beschikbaar', 'Plain-language assessment': 'Begrijpelijke samenvatting', 'The main result first; method details remain available below.': 'Eerst het hoofdresultaat; methodedetails blijven hieronder beschikbaar.', 'Current background context': 'Huidige achtergrondcontext', 'Data basis': 'Gegevensbasis', '{days} covered days · {observed} daily observations': '{days} gedekte dagen · {observed} dagelijkse waarnemingen', 'Integrated derived dose in the measured period': 'Geïntegreerde afgeleide dosis in de meetperiode', 'Seasonal assessment': 'Seizoensbeoordeling', '{months} represented calendar months': '{months} vertegenwoordigde kalendermaanden', 'Extended statistical methods': 'Uitgebreide statistische methoden', 'Confidence intervals, effective sample size, test statistics and practical effect size': 'Betrouwbaarheidsintervallen, effectieve steekproefgrootte, toetsstatistieken en praktisch effect', 'Trend method details': 'Details van de trendmethode', 'Statistical process diagnostics': 'Statistische procesdiagnostiek', 'EWMA, CUSUM and dispersion diagnostics; statistical context only': 'EWMA-, CUSUM- en spreidingsdiagnostiek; alleen statistische context', 'Exploratory Spearman correlations with false-discovery-rate correction': 'Verkennende Spearman-correlaties met correctie voor fout-ontdekkingspercentage', 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.': 'Omgevingscorrelaties zijn verkennend. De Benjamini-Hochberg-correctie vermindert foutieve ontdekkingen tussen geteste vertragingen, maar rechtvaardigt geen causale conclusie.', 'Long-term reliability field test': 'Veldtest voor langetermijnbetrouwbaarheid', 'Operational counters for USB, database continuity and GMCMap transmission': 'Bedrijfstellers voor USB, databasecontinuïteit en GMCMap-overdracht', 'Annual projection from the last 90 days: {value} µSv': 'Jaarprojectie op basis van de laatste 90 dagen: {value} µSv', 'Annual projection is not shown until a sufficiently complete 90-day period exists.': 'De jaarprojectie verschijnt pas na een voldoende volledige periode van 90 dagen.'})


# Sidebar navigation and responsive application shell 9.3.0
CATALOG.update({'Main navigation': 'Hoofdnavigatie', 'Monitoring': 'Monitoring', 'Evaluation': 'Evaluatie', 'Documentation': 'Documentatie', 'Administration': 'Beheer', 'Close navigation': 'Navigatie sluiten', 'Skip to content': 'Naar de inhoud', 'Menu': 'Menu', 'Refresh': 'Vernieuwen'})

# Global view control and long-term interpretation context 9.4.0
CATALOG.update({'Choose how many details and tools are shown across all sections. The selection is stored in this browser.': 'Bepaalt hoeveel details en hulpmiddelen in alle onderdelen worden weergegeven. De keuze wordt in deze browser opgeslagen.', 'Long-term interpretation context': 'Context voor langetermijninterpretatie', 'Intelligent analysis, adaptive background and cosmic-influence context for the selected detector.': 'Intelligente analyse, adaptieve achtergrond en statistische context van kosmische invloed voor de geselecteerde detector.'})
