...
CATALOG.update({'24 hours': '24 godziny', '30 days': '30 dni', '365 days': '365 dni', '7 days': '7 dni', '7-day rolling median': 'Krocząca mediana 7-dniowa', '90 days': '90 dni', '95% block-bootstrap interval for mean': '95% przedział bootstrap blokowy dla średniej', '95% block-bootstrap interval for median': '95% przedział bootstrap blokowy dla mediany', 'Air-pressure association': 'Związek z ciśnieniem atmosferycznym', 'Annual projection from the last 30 days: {value} µSv': 'Projekcja roczna na podstawie ostatnich 30 dni: {value} µSv', 'Annual projection is not shown until a sufficiently complete 30-day period exists.': 'Projekcja roczna jest wyświetlana dopiero po uzyskaniu wystarczająco kompletnego okresu 30 dni.', 'Based on {hours} covered hours': 'Na podstawie {hours} godzin z danymi', 'Bootstrap uncertainty, distribution dispersion, EWMA and CUSUM': 'Niepewność bootstrap, rozproszenie, EWMA i CUSUM', 'Calendar heat map': 'Kalendarzowa mapa cieplna', 'Calendar heat map of daily median CPM': 'Mapa cieplna dziennych median CPM', 'Connected periods above the robust local long-term threshold': 'Ciągłe okresy powyżej odpornego lokalnego progu długoterminowego', 'Contextual Fano-like ratio; rolling CPM values are not independent Poisson counts': 'Kontekstowy współczynnik podobny do Fano; kroczące wartości CPM nie są niezależnymi zliczeniami Poissona', 'Correlation does not prove causation.': 'Korelacja nie dowodzi związku przyczynowego.', 'Coverage {coverage}% · at least {required}% required': 'Pokrycie {coverage}% · wymagane co najmniej {required}%', 'Covered hours': 'Godziny z danymi', 'Cumulative derived dose': 'Skumulowana dawka pochodna', 'Daily and monthly development': 'Rozwój dzienny i miesięczny', 'Daily median': 'Mediana dzienna', 'Daily median and 7-day rolling median': 'Mediana dzienna i krocząca mediana 7-dniowa', 'Daily medians, rolling median and calendar view': 'Mediany dzienne, mediana krocząca i widok kalendarza', 'Derived cumulative dose: {dose} µSv': 'Skumulowana dawka pochodna: {dose} µSv', 'Derived dose (µSv)': 'Dawka pochodna (µSv)', 'Derived from the robust local background; not an official alarm threshold': 'Wyznaczony z odpornego lokalnego tła; nie jest oficjalnym progiem alarmowym', 'Duration (h)': 'Czas trwania (h)', 'EWMA, CUSUM, trend tests and relative event detection provide statistical context only. They do not identify a radiation source and do not replace calibrated radiation-protection measurements.': 'EWMA, CUSUM, testy trendu i względne wykrywanie zdarzeń zapewniają jedynie kontekst statystyczny. Nie identyfikują źródła promieniowania i nie zastępują kalibrowanych pomiarów ochrony radiologicznej.', 'Effective sample size': 'Efektywna liczebność próby', 'Environmental correlations are exploratory. They may reflect common time patterns, ventilation, weather or other confounding factors and do not prove causation.': 'Korelacje środowiskowe są eksploracyjne. Mogą odzwierciedlać wspólne wzorce czasowe, wentylację, pogodę lub inne czynniki i nie dowodzą przyczynowości.', 'Excess area (CPM·h)': 'Pole przekroczenia (CPM·h)', 'Exploratory Spearman correlations at 0, 3, 6, 12 and 24 hour lags': 'Eksploracyjne korelacje Spearmana z opóźnieniami 0, 3, 6, 12 i 24 godziny', 'Higher': 'Wyżej', 'Hourly dispersion ratio': 'Godzinowy współczynnik rozproszenia', 'Lagged environmental associations': 'Opóźnione związki środowiskowe', 'Long-term analysis': 'Analiza długoterminowa', 'Long-term analysis for {device}': 'Analiza długoterminowa dla {device}', 'Long-term background, cumulative dose, trend, recurring patterns and statistical process diagnostics': 'Tło długoterminowe, dawka skumulowana, trend, powtarzalne wzorce i diagnostyka statystyczna procesu', 'Long-term overview': 'Przegląd długoterminowy', 'Long-term statistical diagnostics': 'Długoterminowa diagnostyka statystyczna', 'Long-term trend': 'Trend długoterminowy', 'Lower': 'Niżej', 'Mann-Kendall test with Sen slope on sufficiently covered daily medians': 'Test Manna-Kendalla z nachyleniem Sena dla wystarczająco kompletnych median dziennych', 'Maximum CPM': 'Maksymalne CPM', 'Mean CPM': 'Średnie CPM', 'Median CPM': 'Mediana CPM', 'Median {median} CPM · coverage {coverage}%': 'Mediana {median} CPM · pokrycie {coverage}%', 'Month': 'Miesiąc', 'Monthly aggregates': 'Agregaty miesięczne', 'Moving blocks preserve short-range time dependence': 'Ruchome bloki zachowują krótkookresową zależność czasową', 'No calendar data available': 'Brak danych kalendarzowych', 'No long-term analysis available yet': 'Analiza długoterminowa nie jest jeszcze dostępna', 'No monthly aggregates available': 'Brak agregatów miesięcznych', 'No persistent CUSUM signal detected': 'Nie wykryto trwałego sygnału CUSUM', 'No persistent EWMA signal detected': 'Nie wykryto trwałego sygnału EWMA', 'No persistent relative elevation episodes detected': 'Nie wykryto trwałych względnych epizodów podwyższenia', 'No supported dose conversion for this period': 'Brak obsługiwanej konwersji dawki dla tego okresu', 'No value is calculated until enough hourly pairs are available.': 'Wartość nie jest obliczana, dopóki nie będzie wystarczającej liczby par godzinowych.', 'Not enough daily values for a long-term chart': 'Za mało wartości dziennych do wykresu długoterminowego', 'Not enough paired data': 'Za mało sparowanych danych', 'Not yet meaningful': 'Jeszcze niemiarodajne', 'Only {covered} of {required} days covered': 'Pokryto tylko {covered} z {required} dni', 'Persistent elevation episodes': 'Trwałe epizody podwyższenia', 'Persistent episodes': 'Trwałe epizody', 'Preliminary': 'Wstępne', 'Ready': 'Możliwe do oceny', 'Real time windows with duration and coverage checks': 'Rzeczywiste okna czasowe z kontrolą czasu trwania i pokrycia', 'Recent 7-day median relative to the robust long-term background': 'Ostatnia 7-dniowa mediana względem odpornego tła długoterminowego', 'Recent background deviation': 'Ostatnie odchylenie od tła', 'Relative event threshold': 'Względny próg zdarzenia', 'Robust local background': 'Odporne tło lokalne', 'Scientific interpretation': 'Interpretacja naukowa', 'Start': 'Początek', 'Statistical signal detected': 'Wykryto sygnał statystyczny', 'Stored measurements are required before long-term statistics can be calculated.': 'Do obliczenia statystyk długoterminowych wymagane są zapisane pomiary.', 'Strongest at {lag} h lag · {pairs} pairs · {strength} association': 'Najsilniejszy związek przy opóźnieniu {lag} h · {pairs} par · związek {strength}', 'Temperature association': 'Związek z temperaturą', 'The detector uses the robust long-term local background and does not replace radiation-safety alarms.': 'Detekcja wykorzystuje odporne lokalne tło długoterminowe i nie zastępuje alarmów ochrony radiologicznej.', 'Time at or above configured danger threshold': 'Czas na lub powyżej skonfigurowanego progu zagrożenia', 'Time in configured warning range': 'Czas w skonfigurowanym zakresie ostrzegawczym', 'Typical range P05–P95: {low}–{high} CPM': 'Typowy zakres P05-P95: {low}-{high} CPM', 'moderate': 'umiarkowany', 'strong': 'silny', 'weak': 'słaby', '{date}: median {median} CPM, coverage {coverage}%': '{date}: mediana {median} CPM, pokrycie {coverage}%', '{direction} · {slope} CPM/day · p={p}': '{direction} · {slope} CPM/dzień · p={p}', '{hours} covered hours': '{hours} godzin z danymi', '{hours} total elevated hours · longest {longest} h': 'Łącznie {hours} podwyższonych godzin · najdłużej {longest} h', '{observed} daily observations · correlation duration {duration} days': '{observed} obserwacji dziennych · czas korelacji {duration} dni', '{replicates} replicates · block length {block} days': '{replicates} powtórzeń · długość bloku {block} dni', 'Long-term': 'Długi okres', 'stable': 'stabilny', 'increasing': 'rosnący', 'decreasing': 'malejący'})

# Recent baseline wording 9.1.1
CATALOG.update({'Recent baseline context': 'Bieżący kontekst poziomu odniesienia', 'Seven-day baseline deviation, drift and sustained relative events': 'Odchylenie od 7-dniowego poziomu odniesienia, dryf i trwałe zdarzenia względne'})


# Extended agreement and seasonal analysis 9.1.1
CATALOG.update({'Bland-Altman bias': 'Obciążenie Bland-Altman', '95% limits of agreement': '95% granice zgodności', 'Mean signed difference A minus B': 'Średnia różnica ze znakiem A minus B', 'Exploratory paired-device agreement; correlation alone does not establish agreement.': 'Eksploracyjna zgodność sparowanych urządzeń; sama korelacja nie dowodzi zgodności.', 'Seasonal month-of-year profile': 'Profil sezonowy według miesiąca roku', 'Median CPM by calendar month across available years': 'Mediana CPM dla miesiąca kalendarzowego w dostępnych latach', 'Calendar month': 'Miesiąc kalendarzowy', 'Days represented': 'Uwzględnione dni', 'Not enough months for a seasonal profile': 'Za mało miesięcy do profilu sezonowego', 'At least six represented calendar months are required.': 'Wymagane jest co najmniej sześć reprezentowanych miesięcy kalendarzowych.', 'Exploratory seasonal summary; it does not separate weather, location, detector or calibration changes.': 'Eksploracyjne podsumowanie sezonowe; nie rozdziela zmian pogody, lokalizacji, detektora ani kalibracji.'})


# Evidence-based long-term presentation and field-test diagnostics 9.3.0
CATALOG.update({'{available} of {required} required hourly pairs are available.': '{available} of {required} required hourly pairs are available.', 'FDR-adjusted p={value}': 'FDR-adjusted p={value}', 'Practical magnitude not available': 'Practical magnitude not available', 'Moderate practical magnitude': 'Moderate practical magnitude', 'Estimated change {value}% per month · {magnitude}': 'Estimated change {value}% per month · {magnitude}', 'Runtime since service start': 'Runtime since service start', 'Cumulative counters reset when the service restarts.': 'Cumulative counters reset when the service restarts.', 'GMCMap transmission': 'GMCMap transmission', 'Export field-test protocol (JSON)': 'Eksportuj protokół testu terenowego (JSON)', '{months} represented calendar months': '{months} represented calendar months', 'Statistical process diagnostics': 'Diagnostyka procesu statystycznego', 'At least 30 sufficiently complete days and an adequate effective sample size are required.': 'At least 30 sufficiently complete days and an adequate effective sample size are required.', '{success} successful · {errors} failed uploads': '{success} successful · {errors} failed uploads', 'No statistically clear long-term trend is visible': 'No statistically clear long-term trend is visible', 'Longest data gap': 'Longest data gap', 'Stored samples: {count}': 'Stored samples: {count}', 'Field-test interpretation': 'Field-test interpretation', 'A falling long-term tendency is visible': 'A falling long-term tendency is visible', 'Large practical magnitude': 'Large practical magnitude', '{days} covered days · {observed} daily observations': '{days} covered days · {observed} daily observations', 'Data basis': 'Podstawa danych', 'A rising long-term tendency is visible': 'A rising long-term tendency is visible', 'Small practical magnitude': 'Small practical magnitude', 'Current background context': 'Aktualny kontekst tła', 'Annual projection from the last 90 days: {value} µSv': 'Roczna projekcja z ostatnich 90 dni: {value} µSv', 'The main result first; method details remain available below.': 'The main result first; method details remain available below.', 'Annual projection is not shown until a sufficiently complete 90-day period exists.': 'Projekcja roczna wymaga wystarczająco kompletnego okresu 90 dni.', 'Supported': 'Wiarygodne', 'Well supported': 'Bardzo dobrze potwierdzone', 'Extended statistical methods': 'Rozszerzone metody statystyczne', 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.': 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.', 'USB / serial recovery': 'USB / serial recovery', 'Database write errors': 'Database write errors', 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.': 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.', 'Plain-language assessment': 'Zrozumiałe podsumowanie', '{errors} serial errors · {reconnects} reconnects': '{errors} serial errors · {reconnects} reconnects', 'Long-term reliability field test': 'Test długoterminowej niezawodności', 'No reliable long-term trend can be assessed yet': 'No reliable long-term trend can be assessed yet', 'Operational counters for USB, database continuity and GMCMap transmission': 'Operational counters for USB, database continuity and GMCMap transmission', 'EWMA, CUSUM and dispersion diagnostics; statistical context only': 'EWMA, CUSUM and dispersion diagnostics; statistical context only', '{count} detected gaps above the expected interval': '{count} detected gaps above the expected interval', 'Trend method details': 'Trend method details', 'FDR-adjusted significance not available': 'FDR-adjusted significance not available', 'Exploratory Spearman correlations with false-discovery-rate correction': 'Exploratory Spearman correlations with false-discovery-rate correction', 'Seasonal assessment': 'Seasonal assessment', 'Not evaluable': 'Brak możliwości oceny', 'Integrated derived dose in the measured period': 'Integrated derived dose in the measured period', 'Exploratory': 'Eksploracyjne', 'Confidence intervals, effective sample size, test statistics and practical effect size': 'Confidence intervals, effective sample size, test statistics and practical effect size', 'Very small practical magnitude': 'Very small practical magnitude'})

# Complete localized overrides for 9.3.0
CATALOG.update({'Not evaluable': 'Brak możliwości oceny', 'Exploratory': 'Eksploracyjne', 'Supported': 'Wiarygodne', 'Well supported': 'Bardzo dobrze potwierdzone', 'Very small practical magnitude': 'Bardzo mała wielkość praktyczna', 'Small practical magnitude': 'Mała wielkość praktyczna', 'Moderate practical magnitude': 'Umiarkowana wielkość praktyczna', 'Large practical magnitude': 'Duża wielkość praktyczna', 'Practical magnitude not available': 'Wielkość praktyczna niedostępna', 'No reliable long-term trend can be assessed yet': 'Nie można jeszcze ocenić wiarygodnego trendu długoterminowego', 'At least 30 sufficiently complete days and an adequate effective sample size are required.': 'Wymagane jest co najmniej 30 wystarczająco kompletnych dni oraz odpowiednia efektywna liczebność próby.', 'A rising long-term tendency is visible': 'Widoczna jest rosnąca tendencja długoterminowa', 'A falling long-term tendency is visible': 'Widoczna jest malejąca tendencja długoterminowa', 'No statistically clear long-term trend is visible': 'Brak statystycznie wyraźnego trendu długoterminowego', 'Estimated change {value}% per month · {magnitude}': 'Szacowana zmiana {value}% miesięcznie · {magnitude}', 'Runtime since service start': 'Czas pracy od uruchomienia usługi', 'Cumulative counters reset when the service restarts.': 'Liczniki skumulowane są zerowane po ponownym uruchomieniu usługi.', 'USB / serial recovery': 'Odzyskiwanie USB / portu szeregowego', '{errors} serial errors · {reconnects} reconnects': '{errors} błędów portu szeregowego · {reconnects} ponownych połączeń', 'Longest data gap': 'Najdłuższa luka w danych', '{count} detected gaps above the expected interval': '{count} wykrytych luk powyżej oczekiwanego interwału', 'Database write errors': 'Błędy zapisu bazy danych', 'Stored samples: {count}': 'Zapisane próbki: {count}', 'GMCMap transmission': 'Transmisja GMCMap', '{success} successful · {errors} failed uploads': '{success} udanych · {errors} nieudanych wysyłek', 'Export field-test protocol (JSON)': 'Eksportuj protokół testu terenowego (JSON)', 'Field-test interpretation': 'Interpretacja testu terenowego', 'These operational counters help assess long-term reliability. They do not certify detector calibration or measurement accuracy.': 'Te liczniki operacyjne pomagają ocenić niezawodność długoterminową. Nie certyfikują kalibracji detektora ani dokładności pomiaru.', '{available} of {required} required hourly pairs are available.': 'Dostępnych jest {available} z {required} wymaganych par godzinowych.', 'FDR-adjusted p={value}': 'p po korekcie FDR={value}', 'FDR-adjusted significance not available': 'Istotność po korekcie FDR niedostępna', 'Plain-language assessment': 'Zrozumiałe podsumowanie', 'The main result first; method details remain available below.': 'Najpierw główny wynik; szczegóły metod pozostają dostępne poniżej.', 'Current background context': 'Aktualny kontekst tła', 'Data basis': 'Podstawa danych', '{days} covered days · {observed} daily observations': '{days} dni pokrycia · {observed} obserwacji dziennych', 'Integrated derived dose in the measured period': 'Zintegrowana dawka pochodna w okresie pomiaru', 'Seasonal assessment': 'Ocena sezonowa', '{months} represented calendar months': '{months} reprezentowanych miesięcy kalendarzowych', 'Extended statistical methods': 'Rozszerzone metody statystyczne', 'Confidence intervals, effective sample size, test statistics and practical effect size': 'Przedziały ufności, efektywna liczebność próby, statystyki testowe i efekt praktyczny', 'Trend method details': 'Szczegóły metody trendu', 'Statistical process diagnostics': 'Diagnostyka procesu statystycznego', 'EWMA, CUSUM and dispersion diagnostics; statistical context only': 'Diagnostyka EWMA, CUSUM i rozproszenia; wyłącznie kontekst statystyczny', 'Exploratory Spearman correlations with false-discovery-rate correction': 'Eksploracyjne korelacje Spearmana z korektą współczynnika fałszywych odkryć', 'Environmental correlations are exploratory. Benjamini-Hochberg correction reduces false discoveries across tested lags, but no causal conclusion is justified.': 'Korelacje środowiskowe są eksploracyjne. Korekta Benjamini-Hochberga ogranicza fałszywe odkrycia w badanych opóźnieniach, lecz nie uzasadnia wniosków przyczynowych.', 'Long-term reliability field test': 'Test terenowy niezawodności długoterminowej', 'Operational counters for USB, database continuity and GMCMap transmission': 'Liczniki operacyjne USB, ciągłości bazy danych i transmisji GMCMap', 'Annual projection from the last 90 days: {value} µSv': 'Roczna projekcja z ostatnich 90 dni: {value} µSv', 'Annual projection is not shown until a sufficiently complete 90-day period exists.': 'Projekcja roczna jest wyświetlana dopiero po wystarczająco kompletnym okresie 90 dni.'})


# Sidebar navigation and responsive application shell 9.3.0
CATALOG.update({'Main navigation': 'Nawigacja główna', 'Monitoring': 'Monitorowanie', 'Evaluation': 'Ocena', 'Documentation': 'Dokumentacja', 'Administration': 'Administracja', 'Close navigation': 'Zamknij nawigację', 'Skip to content': 'Przejdź do treści', 'Menu': 'Menu', 'Refresh': 'Odśwież'})

# Global view control and long-term interpretation context 9.4.0
CATALOG.update({'Choose how many details and tools are shown across all sections. The selection is stored in this browser.': 'Określa, ile szczegółów i narzędzi jest wyświetlanych we wszystkich sekcjach. Wybór jest zapisywany w tej przeglądarce.', 'Long-term interpretation context': 'Kontekst interpretacji długoterminowej', 'Intelligent analysis, adaptive background and cosmic-influence context for the selected detector.': 'Inteligentna analiza, adaptacyjne tło i statystyczny kontekst wpływu kosmicznego dla wybranego detektora.'})
