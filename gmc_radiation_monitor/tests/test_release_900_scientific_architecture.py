...
def test_dashboard_uses_versioned_assets_compact_live_api_and_unified_report_form(tmp_path: Path) -> None:
    ...
    assert './assets/dashboard.css?v=9.0.3' in page
    assert './assets/dashboard.js?v=9.0.3' in page
